...
class Dashboardcontroller extends Controller
{
    public function index(Request $request)
    {
        ...
        // ── Stats (ONLY members in same section) ─────────────────────────────
        ...
        // ── Members table (ONLY members in same section) ─────────────────────
        $members = User::query()
            ->where('role', 'member') // ✅ مهم: غير members
            ->where('section_id', $adminSectionId) // ✅ نفس section
            ->when($search, fn ($q) => $q
